...
if __name__ == "__main__":
    # 读取数据
    iris = pd.read_csv('D:\\projects\\PyCharmProjects\\ML\\BPNeuralNetwork\\bpnn_V1数据集\\iris_training.csv')
    ...
    # 对模型进行测试
    data_test = pd.read_csv('D:\\projects\\PyCharmProjects\\ML\\BPNeuralNetwork\\bpnn_V1数据集\\iris_test.csv')
